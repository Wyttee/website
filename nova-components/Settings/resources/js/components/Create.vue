<template>
    <div>
        <h1 class="mb-3 text-90 font-normal text-2xl">Create</h1>
        <div class="card overflow-hidden">
            <form @submit.prevent="create">
                ...
                <div class="bg-30 flex px-8 py-4">
                    <button dusk="update-button" class="ml-auto btn btn-default btn-primary mr-3">Create</button>
                </div>
            </form>
            <Previous></Previous>
        </div>
    ...
    methods: {
        create () {
            axios.post('/nova-vendor/settings/create', {
                ...
                this.$toasted.show("The "+ this.item.key + " key has been created successfully", {
                    position: 'top-right',
                    type: 'success',
                    duration: 2000
                });
